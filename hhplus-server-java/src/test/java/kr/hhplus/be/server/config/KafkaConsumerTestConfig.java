...
public class KafkaConsumerTestConfig {
    ...
    private static final Logger log = LoggerFactory.getLogger(KafkaConsumerTestConfig.class);
    ...
    public KafkaConsumerTestConfig(KafkaTemplate<String, String> kafkaTemplate, OutboxRepository outboxRepository) {
