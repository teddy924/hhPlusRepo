...
public class ProductController {
    ...
    public ResponseEntity<ResponseApi<List<ProductResponseDTO>>> retrieve (
        ...
        List<ProductQueryDto> queryDtoList = productQueryService.retrieveAll(category);

        List<ProductResponseDTO> responseList = ProductResponseDTO.fromList(queryDtoList);
    ...
    public ResponseEntity<ResponseApi<ProductResponseDTO>> retrieve (
        ...
        ProductQueryDto queryDto = productQueryService.retrieveDetail(productId);

        ProductResponseDTO responseDto = ProductResponseDTO.from(queryDto);
    ...
    public ResponseEntity<ResponseApi<List<ProductResponseDTO>>> retrieveTop(
        ...
        List<ProductQueryDto> queryDtoList = productQueryService.retrieveTopRank(category);
